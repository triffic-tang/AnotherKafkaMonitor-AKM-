$(document).ready(function() {
	...
	$("#topic_name_header").find("strong").html("<a href='/AnotherKafkaMonitor/consumers/offset/" + group + "/" + topic + "/realtime'>" + topic + "</a>");
	...
	function offsetDetail() {
		...
		$("#result_children" + offset).dataTable({
			...
			"sAjaxSource" : "/AnotherKafkaMonitor/consumer/offset/" + group + "/" + topic + "/ajax",
			"aoColumns" : [ {
				"mData" : 'partition'
			}, {
				"mData" : 'logsize'
