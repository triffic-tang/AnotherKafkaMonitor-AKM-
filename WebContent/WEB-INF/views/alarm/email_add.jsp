...
<title>Alarm - AnotherKafkaMonitor</title>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form id="form" action='javascript:return false;' method="post">
...
<script type="text/javascript">
	...
	function contextFormValid() {
		...
		form.action = "/AnotherKafkaMonitor/alarm/add/form";
		form.submit();
	}
</script>
</html>
